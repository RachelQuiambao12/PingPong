...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "PingPong.py"

        #Name of program
        self.project_name = "Ping Pong"

        #Project url
        self.project_url = "https://github.com/RachelQuiambao12/PingPong"
        ...
        #Auhor of program
        self.author_name = "Me"
        self.author_email = "chelchel1220@gmail.com"
        self.copyright = "Copyright (c) 2015."

        #Description
        self.project_description = "This is a simple ping pong game."
